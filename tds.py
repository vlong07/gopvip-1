...
# Đoạn code sau sẽ chỉ chạy khi subfile.py được chạy trực tiếp
...
def error(id, type):
    ...
    #print(Colorate.Horizontal(Colors.blue_to_purple, error_message), end='\r'); sleep(1); print('                                                         ', end = '\r')
		...
		for cookie in list_cookie:
			...
			while True:
				...
				if nvlike3 == 1:
					...
					if listlike3 == False:
						print('Không Get Được Nhiệm Vụ Like 3                        ', end = '\r');sleep(5); print('                                                        ', end = '\r')
						nvlike3 = 0
						...
						if len(listlike3) == 0:
							print('Hết Nhiệm Vụ Like 3                                  ', end = '\r');sleep(5); print('                                                        ', end = '\r')
							nvlike3 = 0
						else:
							print(f'\033[1;37mTìm Thấy {len(listlike3)} Nhiệm Vụ Like 3                  ', end = '\r')
							for x in listlike3:
								id = x['id']
								like = fb.like(id, 'LIKE')
								if like == False:
